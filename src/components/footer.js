            ...
            <div className="  px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="space-y-2 text-sm">
                        <p className="text-base font-bold tracking-wide text-green-100">
                            Contacts
                        </p>
                        <div className="flex">
                        ...
                        <div className="flex">
                            <p className="mr-1 text-green-200">Email:</p>
                            <a
                        ...
                        <div className="flex">
                            <p className="mr-1 text-green-200">Address:</p>
                            <a
                    ...
                    <div>
                        <span className="text-base font-bold tracking-wide text-green-100">
                            Social
                        </span>
